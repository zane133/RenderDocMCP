...
from make_step4_140315 import CB_ALIASES, SAMPLERS, SHADERS, TEXTURES  # noqa: E402

STEP1 = SHADERS / "zmd_ps_20260922_140315_step1_renderdoc.hlsl"
STEP4 = SHADERS / "zmd_ps_20260922_140315_step4_readable.hlsl"
...
def main() -> int:
    ...
    for i, (a, b) in enumerate(zip(want, got)):
        if a != b:
            print(f"  first diff at code line {i}:\n    step1: {a}\n    step4: {b}", file=sys.stderr)
            break
    if len(want) != len(got):
