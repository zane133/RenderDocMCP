        ...
        if (r14.y == 0) {
          ...
          if (r14.w != 0) {
            if (r13.z == 0) {
              ...
              r14.w = r14.w ? 0.000000 : 0;
              r16.w = dot(abs(r20.xy), icb[r14.w+0].xy);
              r16.w = cmp(r16.w < abs(r20.z));
              r14.w = r16.w ? 2 : r14.w;
              r16.w = dot(r20.xyz, icb[r14.w+0].xyz);
              r16.w = cmp(r16.w < 0);
              bitmask.w = ((~(-1 << 31)) << 1) & 0xffffffff;  r14.w = (((uint)r14.w << 1) & bitmask.w) | ((uint)r16.w & ~bitmask.w);
              r16.w = (uint)r14.w >> 1;
            ...
            if (r15.w == 0) {
              ...
              if (cb3[r8.z+6].w != 0) {
                if (r13.z == 0) {
                  ...
                  if (8 == 0) r20.x = 0; else if (8+16 < 32) {                   r20.x = (uint)cb3[r14.y+6].w << (32-(8 + 16)); r20.x = (uint)r20.x >> (32-8);                  } else r20.x = (uint)cb3[r14.y+6].w >> 16;
                  if (8 == 0) r20.y = 0; else if (8+8 < 32) {                   r20.y = (uint)cb3[r14.y+6].w << (32-(8 + 8)); r20.y = (uint)r20.y >> (32-8);                  } else r20.y = (uint)cb3[r14.y+6].w >> 8;
                  r17.y = r17.y ? r18.y : r20.x;
                  r14.y = 255 & asint(cb3[r14.y+6].w);
                  r14.y = r17.z ? r20.y : r14.y;
                  if (8 == 0) r17.z = 0; else if (8+8 < 32) {                   r17.z = (uint)cb3[r8.z+6].x << (32-(8 + 8)); r17.z = (uint)r17.z >> (32-8);                  } else r17.z = (uint)cb3[r8.z+6].x >> 8;
