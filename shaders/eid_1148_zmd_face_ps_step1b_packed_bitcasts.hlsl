// ZMD face pixel shader - Stage 1b packed-cbuffer bitcast correction.
// Capture: D:\Capture\ZMD\Endfield_2026.01.29_17.33_frame22692.rdc
// Event: 1148, shader ResourceId::27176
// Original DXBC hash: 5b6c9350-3ba6f256-113cc690-f28b38e0
// Original DXBC: 46,648 bytes / 1,441 instructions.
// 3Dmigoto binary validation passed before the minimal RenderDoc patches below.
// Do not rename, restructure, or remove paths until Apply Changes matches.
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r10.xyzw = t18.SampleBias(s6_s, v1.xy, cb0[108].x).xyzw;
  r6.xz = v2.xz + -r6.yx;
  ...
  r25.y = v1.y;
  r25.xyzw = t17.SampleLevel(s5_s, r25.xy, 0).xyzw;
  r13.z = r25.x + r25.y;
  r14.w = -r25.z * 2 + 1;
  r16.w = r25.z * 2 + -1;
  r16.w = r16.w + -r14.w;
            ...
            if (r19.w == 0) {
              ...
              if (cb3[r16.z+6].w != 0) {
                if (r15.y == 0) {
                  ...
                  // Original DXBC applies ubfe to the typeless cbuffer bits.
                  // Numeric float-to-uint conversion changes these packed flags.
                  if (8 == 0) r22.z = 0; else if (8+16 < 32) {                   r22.z = asuint(cb3[r22.x+6].w) << (32-(8 + 16)); r22.z = (uint)r22.z >> (32-8);                  } else r22.z = asuint(cb3[r22.x+6].w) >> 16;
                  if (8 == 0) r22.w = 0; else if (8+8 < 32) {                   r22.w = asuint(cb3[r22.x+6].w) << (32-(8 + 8)); r22.w = (uint)r22.w >> (32-8);                  } else r22.w = asuint(cb3[r22.x+6].w) >> 8;
                  r21.z = r24.x ? r21.z : r22.z;
                  r22.x = 255 & asint(cb3[r22.x+6].w);
                  r22.x = r24.y ? r22.w : r22.x;
                  if (8 == 0) r22.z = 0; else if (8+8 < 32) {                   r22.z = asuint(cb3[r16.z+6].x) << (32-(8 + 8)); r22.z = (uint)r22.z >> (32-8);                  } else r22.z = asuint(cb3[r16.z+6].x) >> 8;
