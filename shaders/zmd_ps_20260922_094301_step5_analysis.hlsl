...
// Builds on Apply-OK Step 4d. Also fixes the cb0[109].xxx → exposureScale
// alias bug (previously left a broken exposureScalexx identifier).
//
// STEP_*: default 1 = original. Off = true identity / no contribution.
// DEBUG_VIS: 0 = final o0; 1..N = pre-combine intermediates (see below).
//
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r5.y = max(0, r5.y);
  r5.y = min(0.5, r5.y);
  // ===== rim / 边缘光 (uses rimColor, N·V in r26.x) =====
  r23.y = 0;
  r23.xz = rimAxisZW;
