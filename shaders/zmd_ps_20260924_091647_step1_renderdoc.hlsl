            ...
            if (r17.w == 0) {
              ...
              if (cb3[r14.z+6].w != 0) {
                if (r13.w == 0) {
                  ...
                  r24.x = (asuint(cb3[r19.x+6].w) >> 16) & 0xffu; // [patch] ubfe(8,16): asuint bitcast, not (uint)float
                  r24.y = (asuint(cb3[r19.x+6].w) >> 8) & 0xffu; // [patch] ubfe(8,8): asuint bitcast, not (uint)float
                  r19.z = r22.x ? r19.z : r24.x;
                  r19.x = 255 & asint(cb3[r19.x+6].w);
                  r19.x = r22.y ? r24.y : r19.x;
                  r19.w = (asuint(cb3[r14.z+6].x) >> 8) & 0xffu; // [patch] ubfe(8,8): asuint bitcast, not (uint)float
