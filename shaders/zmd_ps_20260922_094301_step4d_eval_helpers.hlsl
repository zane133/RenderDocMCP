// ZMD / Endfield PS - Step 4d: Eval* helpers (view / normal / F0 / motion)
// Source dump: 3Dmigoto 2026-09-22 09:43:01
// Builds on Apply-OK Step 4c. Helper bodies copy verified register math.
// NOT extracted: volume probes, detail overlay, clustered lights, fog.
// Interpolators stay as v0..v10 in main (no const copies).
//
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r13.w = dot(r2.xyz, r10.xyz); // N·V (viewDir · shadingNormal)
