...
// STEP 1: minimal RenderDoc "Apply Changes" patch. Register-faithful, math untouched.
// Patches vs raw dump:
//   1) "#define cmp -"  -> real cmp() overloads (true -> -1.0, false -> 0.0)
//   2) SV_Position0 -> SV_Position, SV_Target0 -> SV_Target
// Nothing else changed (no renames, no CB reshape, no path removal).
...
// 3Dmigoto declarations (RenderDoc-safe form of "#define cmp -")
