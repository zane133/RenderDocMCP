// EID 7918 pixel shader - Stage 4b readable resources pass.
...
PSOutput main(PSInput input)
{
    ...
    float4 maskTextureSample = dyeIdMask.Sample(materialSampler, input.v1.xy);
    ...
    float4 detailSampleA = clothDetailTexture.Sample(materialSampler, input.v1.xy);
