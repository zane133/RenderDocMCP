// ZMD face pixel shader - Stage 4a section map.
...
//
// This revision differs from the Apply-verified Stage 1 file only by comments.
// Section names marked "inferred" describe observed data flow, not recovered
// source symbols. Registers, expressions, bindings, and control flow are intact.
