// EID 7918 pixel shader - Stage 4i readable material controls.
// Source: current D:\Capture\BG3\handSSSS.rdc, shader hash
// 1288ff5a-12d0d3f6-882c1fc8-590970d9, ps_5_0, 283 DXBC instructions.
//
// Stage 4h was Apply-verified against the original draw. This revision only
// names the seven used .w controls by their observed mathematical role.
// Expressions, accumulation order, VT math, and resource bindings are intact.
...
PSOutput main(PSInput input)
{
    ...
    sampledBaseColor =
        (r2.w != 0.0) ? float3(1.0, 0.0, 0.0) : sampledBaseColor;
