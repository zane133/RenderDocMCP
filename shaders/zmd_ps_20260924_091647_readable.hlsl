...
// =============================================================================
// Dump: 2026-09-24 09:16:47
// Apply-faithful reference: zmd_ps_20260924_091647_step5_analysis.hlsl
//
// This file is recipe-faithful, not binary-perfect.
// Removed by user:
//   - height / volumetric fog (t16) — identity: skip the dump's fog if
// Compact TA recipe (full path lives in step5, using dump else / STEP-off):
//   - volume SH probes t4..t9 → GI stand-in (dir=0, color=1 then sky/AO)
//   - procedural splat / fuzz — N stays TBN; coverage 0 also gates matcap
