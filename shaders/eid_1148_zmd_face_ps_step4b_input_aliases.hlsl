// ZMD face pixel shader - Stage 4b face-SDF input aliases.
...
//
// This revision builds on the Apply-verified Stage 4a file. It adds names only
// at the two face-control texture samples. Section names and channel roles marked
  ...
  out float4 o1 : SV_Target1)
{
  ...
  const float4 faceSdfGuideSample = t17.SampleLevel(s5_s, r25.xy, 0).xyzw;
