// EID 7918 pixel shader - Stage 4g dye evaluation function pass.
// Source: current D:\Capture\BG3\handSSSS.rdc, shader hash
// 1288ff5a-12d0d3f6-882c1fc8-590970d9, ps_5_0, 283 DXBC instructions.
//
// Stage 4f was Apply-verified against the original draw. This revision only
// moves the exact 12-ID distance/weight/tint block into EvaluateDyeTint().
...
PSOutput main(PSInput input)
{
    ...
    r8.yzw = EvaluateDyeTint(dyeIdRGB, material);
