...
// 11 graded colour (after lights / grade, before /exposure)
  ...
  out float4 o1 : SV_Target1)
{
  ...
  // ===== 5. Ambient GI - volume probe cascades REMOVED (user request) =====
