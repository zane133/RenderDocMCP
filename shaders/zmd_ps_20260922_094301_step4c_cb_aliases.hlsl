// ZMD / Endfield PS - Step 4c: CB aliases for lighting / rim / ramp
// Source dump: 3Dmigoto 2026-09-22 09:43:01
// Builds on Step 4b (= 4a math + X4115 asuint fix). Rim note: user OK to proceed
// even if 边缘光 is imperfect. This pass does NOT alias interpolators (v0..v10).
// Adds only:
//   - t10 symbol rename LightingLUT -> RampMap (register t10 unchanged)
//   - CB float aliases for sun / rim / mip bias / exposure (inferred)
//   - short comments at ramp + rim use sites
// Dense volume / light-loop bodies stay register-shaped.
//
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r7.xyz = NormalMap.SampleBias(sampNormal, v1.xy, mipBias).xyw;
  r7.x = r7.z * r7.x;
