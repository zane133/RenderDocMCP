// EID 7918 pixel shader - readable dye + organised VT metadata reconstruction.
// Source: current D:\Capture\BG3\handSSSS.rdc, shader hash
// 1288ff5a-12d0d3f6-882c1fc8-590970d9, ps_5_0, 283 DXBC instructions.
//
// The dye-focused version was Apply-verified against the original draw. This
// revision organises t125 metadata reads into named accessors while preserving
// every word index, duplicate load, VT expression, and operation order.
...
PSOutput main(PSInput input)
{
    ...
    r1 = LoadVTLodParameters(virtualTextureMetadataIndex);
    ...
    float3 dyeTint = EvaluateDyeTint(dyeIdRGB, material);
    ...
    sampledBaseColor =
        (normalBaseVTFallbackMask != 0.0)
            ? float3(1.0, 0.0, 0.0)
            : sampledBaseColor;
    float3 dyedBaseColor = dyeTint * sampledBaseColor;
    float3 towardMaterialOverrideA =
    ...
    r3.w = (normalBaseVTFallbackMask != 0.0) ? 0.0 : r4.w;
    r4.z = saturate(r4.z);
    output.materialParams.z =
        (normalBaseVTFallbackMask != 0.0) ? 1.0 : r4.z;
    r2.w = max(abs(r3.w), 0.0001);
    output.baseColorPhysical.w = r3.w;
    r2.w = log2(r2.w);
    r6.x = clothTertiaryPhysicalExponent;
    r6.y = accentPhysicalExponent;
    r4.z = r2.w * r6.x;
    r4.w = r2.w * r6.y;
    r4.zw = exp2(r4.zw);
    r4.zw = (-r4.zw) + r8.xx;
    ...
    r4.zw = r2.ww + r4.zw;
    r9.x = leatherPrimaryLayerThreshold;
    r9.y = leatherSecondaryLayerThreshold;
    r4.z = (r9.x >= r4.z) ? 1.0 : 0.0;
    r4.w = (r9.y >= r4.w) ? 1.0 : 0.0;
    r10.x = r6.z * clothPrimaryDetailExponent;
    r10.y = r6.w * clothSecondaryDetailExponent;
    r6.z = exp2(r10.x);
    r6.w = exp2(r10.y);
    float2 dyeLayerWeights = r4.zw * r6.zw;
    ...
    // VT-G: repeat the captured descriptor load for the secondary lookup.
    r3.zw = asfloat(int2((int)r0.w, (int)r0.w));
    r0.w = r0.w * 0.25;
    r5 = LoadVTLayerDescriptor(virtualTextureMetadataIndex);
    r10.y = r5.y * r5.x;
    r10.x = r5.x;
    r4.z = r1.y * r10.x;
    r4.w = r1.z * r10.y;
    ...
    float physicalVTFallbackMask =
        (r5.z != VT_VALID_PAGE_TAG) ? 1.0 : 0.0;
    r0.xy = (physicalVTFallbackMask != 0.0) ? 0.0.xx : r0.xy;
