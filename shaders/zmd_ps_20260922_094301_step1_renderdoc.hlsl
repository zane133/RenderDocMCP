// ---- Created with 3Dmigoto v1.4.6 on Tue Sep 22 09:43:01 2026
Texture3D<float4> t20 : register(t20);

Texture2D<float4> t19 : register(t19);

TextureCube<float4> t18 : register(t18);
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r4.xyzw = t14.SampleBias(s3_s, v1.xy, cb0[108].x).xyzw;
  r5.xyzw = t15.SampleBias(s4_s, v1.xy, cb0[108].x).xyzw;
  ...
  r7.xyz = t16.SampleBias(s5_s, v1.xy, cb0[108].x).xyw;
  r7.x = r7.z * r7.x;
  ...
  r8.xyz = t17.SampleBias(s6_s, v1.xy, cb0[108].x).xyz;
  r9.xz = v2.xz + -r3.yx;
  r9.y = 6.10351562e-05;
  ...
  if (r6.w != 0) {
    ...
    if (r7.w != 0) {
      ...
      if (r8.w != 0) {
        ...
        r14.xyw = t4.SampleLevel(s1_s, r13.xyz, 0).yzx;
        r8.w = 1 + -r7.w;
        r9.w = cb0[211].y * 0.5;
        ...
        r15.xyzw = t5.SampleLevel(s0_s, r13.xwz, 0).xyzw;
        r9.w = r15.w * r8.w + r6.w;
        r16.xyz = float3(0,0.666666687,0) + r13.xwz;
        r16.xyz = t5.SampleLevel(s0_s, r16.xyz, 0).xyz;
        ...
        r13.xyz = t5.SampleLevel(s0_s, r13.xyz, 0).xyz;
      ...
      if (r11.w != 0) {
        ...
        r17.xyw = t6.SampleLevel(s1_s, r15.xyz, 0).yzx;
        r11.w = 1 + -r8.w;
        r7.w = r11.w * r7.w;
        r11.w = cb0[211].y * 0.5;
        ...
        r18.xyzw = t7.SampleLevel(s0_s, r15.xwz, 0).xyzw;
        r9.w = r18.w * r7.w + r9.w;
        r19.xyz = float3(0,0.666666687,0) + r15.xwz;
        r19.xyz = t7.SampleLevel(s0_s, r19.xyz, 0).xyz;
        ...
        r15.xyz = t7.SampleLevel(s0_s, r15.xyz, 0).xyz;
        r15.xyz = r15.xyz * float3(4,4,4) + float3(-2,-2,-2);
  ...
  if (r8.w != 0) {
    ...
    r21.xyzw = t12.SampleBias(s3_s, r15.zy, cb0[108].x).xyzw;
    r22.xyzw = t12.SampleBias(s3_s, r15.zw, cb0[108].x).xyzw;
    r22.xyzw = r22.xyzw * r19.zzzz;
    r21.xyzw = r21.xyzw * r19.yyyy + r22.xyzw;
    r22.xyzw = t12.SampleBias(s3_s, r15.yw, cb0[108].x).xyzw;
    ...
    r22.xyz = t13.SampleBias(s3_s, r15.zw, cb0[108].x).xyz;
    r15.yzw = t13.SampleBias(s3_s, r15.yw, cb0[108].x).xyz;
    ...
    r13.y = t13.SampleBias(s3_s, r22.xy, cb0[108].x).w;
    r13.z = t13.SampleBias(s3_s, r22.zw, cb0[108].x).w;
    r13.z = r13.z * r16.x;
  ...
  r26.xyzw = t10.SampleLevel(s0_s, r25.xy, 0).xyzw;
  ...
  r25.z = r13.w * 0.5 + 0.5;
  r13.w = t10.SampleLevel(s0_s, r25.zw, 0).w;
  r14.w = r22.y * r5.z;
  ...
  r23.y = r3.z * r3.w;
  r23.xyz = t11.SampleLevel(s0_s, r23.xy, 0).xyz;
  ...
  r17.xyz = t18.SampleLevel(s0_s, r17.xyz, r2.w).xyz;
  r2.w = 1 + -r7.w;
  r2.w = r2.w / r7.w;
      ...
      if (r14.z != 0) {
        ...
        if (r16.w == 0) {
          ...
          if (r16.w != 0) {
            ...
            r16.w = t19.SampleLevel(s0_s, r19.xy, 0).x;
            r17.z = r17.z * r16.w;
          }
          r14.x = r17.z * r14.x;
            ...
            if (r17.y == 0) {
              ...
              if (cb3[r14.z+6].w != 0) {
                if (r12.z == 0) {
                  ...
                  // ubfe(8, 16, packed) / ubfe(8, 8, packed): asuint bitcast, not (uint)float
                  r23.x = (asuint(cb3[r18.x+6].w) >> 16) & 255;
                  r23.y = (asuint(cb3[r18.x+6].w) >> 8) & 255;
                  r18.w = r20.x ? r18.w : r23.x;
                  r18.x = asuint(cb3[r18.x+6].w) & 255;
                  r18.x = r20.y ? r23.y : r18.x;
                  r19.w = (asuint(cb3[r14.z+6].x) >> 8) & 255;
                  r20.x = asuint(cb3[r14.z+6].x) & 255;
                ...
                if (r18.x != 0) {
                  ...
                  r17.x = t2.SampleCmpLevelZero(s2_s, r30.xy, r18.w).x;
                  r19.w = t2.SampleCmpLevelZero(s2_s, r30.zw, r18.w).x;
                  r19.w = r32.y * r19.w;
                  r17.x = r32.x * r17.x + r19.w;
                  r18.x = t2.SampleCmpLevelZero(s2_s, r18.xz, r18.w).x;
                  r17.x = r32.z * r18.x + r17.x;
                  r18.x = t2.SampleCmpLevelZero(s2_s, r29.xy, r18.w).x;
                  r17.x = r32.w * r18.x + r17.x;
                  r30.xyzw = r27.xyzw * r26.zzww;
                  r18.x = t2.SampleCmpLevelZero(s2_s, r31.xy, r18.w).x;
                  r17.x = r30.x * r18.x + r17.x;
                  r18.x = t2.SampleCmpLevelZero(s2_s, r31.zw, r18.w).x;
                  r17.x = r30.y * r18.x + r17.x;
                  r18.x = t2.SampleCmpLevelZero(s2_s, r29.zw, r18.w).x;
                  r17.x = r30.z * r18.x + r17.x;
                  r18.x = t2.SampleCmpLevelZero(s2_s, r28.xy, r18.w).x;
                  ...
                  r18.z = r27.y * r26.w;
                  r18.w = t2.SampleCmpLevelZero(s2_s, r28.zw, r18.w).x;
  ...
  if (r2.w != 0) {
    ...
    if (r3.w != 0) {
      ...
      // integer mad -> a*b+c (FXC mad is float-oriented)
