// EID 7918 pixel shader - Stage 4a readable dye-ID pass.
// Source: current D:\Capture\BG3\handSSSS.rdc, shader hash
// 1288ff5a-12d0d3f6-882c1fc8-590970d9, ps_5_0, 283 DXBC instructions.
//
// Stage 1 was Apply-verified against the original draw. This revision only
// names the 12 dye IDs and their weight groups. VT and GBuffer paths remain
// register-shaped and operation-ordered.
...
PSOutput main(PSInput input)
{
    ...
    float3 dyeTint = metalCustomWeights.y * cb1[9].xyz;
    dyeTint = metalCustomWeights.x * cb1[8].xyz + dyeTint;
    float3 upperIdTint = metalCustomWeights.w * cb1[11].xyz;
    upperIdTint = metalCustomWeights.z * cb1[10].xyz + upperIdTint;
    ...
    float3 leatherCustomTint = leatherCustomWeights.w * cb1[7].xyz;
    leatherCustomTint = leatherCustomWeights.z * cb1[6].xyz + leatherCustomTint;
    ...
    float3 clothAccentTint = clothAccentWeights.w * cb1[3].xyz;
    clothAccentTint = clothAccentWeights.z * cb1[2].xyz + clothAccentTint;
    float3 leatherPrimarySecondaryTint = leatherCustomWeights.y * cb1[5].xyz;
    leatherPrimarySecondaryTint =
        leatherCustomWeights.x * cb1[4].xyz + leatherPrimarySecondaryTint;
    clothAccentTint = clothAccentTint + leatherPrimarySecondaryTint;
    clothAccentTint = dyeTint + clothAccentTint;
    float3 clothPrimarySecondaryTint = clothAccentWeights.y * cb1[1].xyz;
    clothPrimarySecondaryTint =
        clothAccentWeights.x * cb1[0].xyz + clothPrimarySecondaryTint;
